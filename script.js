...
(function(){
  var editableIds = ['statPersonnel','statApprovals','statRequests','statUptime'];
...
(function(){
  ...
  function emptyStateHtml(){
    ...
    return '<div class="card" style="text-align:center; padding:40px 24px;">'
      ...
      + '</p>'
      + (canConfigure ? '<button class="btn btn-primary" onclick="document.getElementById(\'btnDivConnect\').click()">Connect Google Sheet</button>' : '')
      + '</div>';
  }
